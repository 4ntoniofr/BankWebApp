...
INSERT INTO USUARIO(USUARIO,PASSWORD,FECHA_REGISTRO) VALUES ('gestor','gestor',curdate()), ('asistente','asistente',curdate());
INSERT INTO PERSONA(DNI,NOMBRE,PRIMER_APELLIDO,FECHA_NACIMIENTO) VALUES ('12345678A','Gestor','Gestor',STR_TO_DATE('31-01-2002', '%d-%m-%Y')), ('12345678B','Asistente','Asistente',STR_TO_DATE('17-12-2002', '%d-%m-%Y'));
INSERT INTO EMPLEADO(USUARIO_ID,PERSONA_ID,ROL_EMPLEADO_ID) VALUES (1, 1, 1), (2,2,2);